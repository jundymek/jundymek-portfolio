...
export const translation = {
  ...
  EN: {
    ...
    {
      title: "About me",
      paragraph1part1: "Hi - my name is Łukasz. Currently a Cop👮🏻‍♂️, in the future… programmer. For the last couple of years, I spend all of my free time coding. My programming adventure started when I first wrote",
      paragraph1code: "print 'Hello World'",
      ...
      paragraph2: "I am not declaring myself on any side. I like frontend and backend the same. Most important is real fun when writing code. I dream about working as a programmer full time.",
    },
    projects:
    {
      title: "Projects",
